# **IT/Technical Titles — Call Guide**

**Role guidance:** IT and technical contacts are lateral influencers, not buyers. They care about fit within their tech stack and whether implementation will be painful. They can become strong internal champions if they see a clean path to deployment. Do NOT try to go deep on technical specs. Keep it high-level, stay on the CFO/Controller talk track, and get the AE on the phone for any technical conversation.

---

## **Script IT-1: No Known Trigger (Generic / Discovery)**
...
## **Script IT-2: Frustration with Current Solution**

```
trigger: competitor_frustration
vertical: all
...
**If they start asking detailed technical questions:** You do not need to answer these. Say: "That's exactly what our AE is built for. Can we get 20 minutes on the calendar? They've had this conversation with IT teams in your vertical before and can walk through it in a way that's actually useful."

**If they seem interested and want to champion internally:** That's a win. Ask: "Who on the finance team is the right person to include? I want to make sure you have everything you need to bring this to them."

**If they're skeptical or say IT doesn't evaluate this:** "Totally fair. We usually come in because the finance team is already looking. Is there a Controller or CFO I should be talking to directly?"
